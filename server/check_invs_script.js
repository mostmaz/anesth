    ...
    try {
        ...
        const scriptContent = `
            ...
            async function run() {
                ...
                console.log('Target Patients Found: ' + patients.length);
                ...
                for (const p of patients) {
                    ...
                    console.log('--- Investigations for ' + p.name + ' ---');
                    invs.forEach(i => {
                        console.log('INV: ' + i.title + ' | Date: ' + i.conductedAt.toISOString() + ' | ExtID: ' + i.externalId);
                    });
                }
            }
